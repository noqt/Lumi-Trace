...
For repeatable use, prefer the current [`v0.4.1` GitHub Release](https://github.com/noqt/Lumi-Trace/releases/tag/v0.4.1). The `main` branch is preparing the unreleased `v0.4.2` documentation and package-boundary maintenance update.
